...
def readCommand(argv):
    ...
    parser.add_option('-c', '--classifier', help=default('The type of classifier'),
                      choices=['mostFrequent', 'nb', 'naiveBayes', 'perceptron', 'mira', 'minicontest', 'knn', 'knearestneighbors'],
                      default='naiveBayes')
    parser.add_option('-d', '--data', help=default('Dataset to use'), choices=['digits', 'faces'], default='digits')
    parser.add_option('-t', '--training', help=default('The size of the training set'), default= 45, type="int")
    ...
    parser.add_option('-n', '--neighbors', help=default("Amount of neighbors to use in KNN"), default=1, type="int")
    ...
    elif (options.classifier == "knearestneighbors" or options.classifier == "knn"):
        classifier = kNearestNeighbors.KnnClassifier(legalLabels, options.neighbors)
        # if (options.autotune):
...
def runClassifier(args, options):
    ...
    for i in range(size):
        ...
        # rawValidationData.append(rawValidationData[randomNum])
        # validationLabels.append(validationLabels[randomNum])
    ...
    print ("Training...")
    classifier.train(trainingData, trainingLabels1, validationData, validationLabels)
    print ("Validating...")
